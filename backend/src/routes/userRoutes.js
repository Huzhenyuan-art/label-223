...
router.get('/me/resonance-notifications', auth, userController.getResonanceNotifications);
router.get('/me/resonance-notifications/unread-count', auth, userController.getUnreadResonanceCount);
router.post('/me/resonance-notifications/read', auth, userController.markResonanceNotificationsRead);
